...
app/
 └───handworks_mobile
     ...
     │   │   └───book                           # Booking-related DTOs
     │   ├───models                             # Core app models representing entities
     │   │   ├───bookings                       # Bookings-related models
     │   │   │   ├───cleanings                  # Cleaning types portion of booking
     │   │   │   │   ├───car
     │   │   │   │   ├───couch
     │   │   │   │   ├───general
     │   │   │   │   ├───mattress
     │   │   │   │   └───postconstruction
     │   │   │   ├───infos                      # Info portion of booking
     │   │   │   └───services                   # Service portion of booking
     │   │   ├───users                          # Users-related models
     │   │   └───wrappers                       # Wrapper models
     ...
     │   ├───models                             # UI-specific models (presentation layer models)
